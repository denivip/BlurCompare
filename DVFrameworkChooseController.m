...
@interface DVFrameworkChooseController ()
@property (nonatomic, strong) DVTestViewController *testViewController;
@end
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
     ...
     */
    if (self.testViewController) [self.testViewController removeFromParentViewController];
    self.testViewController = [[DVTestViewController alloc] initWithFramework:indexPath.row];
